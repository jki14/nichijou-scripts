...
function(allstates, event, ...)
    ...
    if not subevent or string.sub(subevent, 1, 6) ~= 'SPELL_' then
        ...
        local modifiedBy = { }
        modifiedBy[54758] = 'Hyperspeed Acceleration'
        modifiedBy[2825] = 'Bloodlust'
        modifiedBy[32182] = 'Heroism'
        modifiedBy[10060] = 'Power Infusion'
        modifiedBy[1714] = 'Curse of Tongues(Rank 1)'
        modifiedBy[11719] = 'Curse of Tongues(Rank 2)'
        modifiedBy[34615] = 'Mind-numbing Poison'
