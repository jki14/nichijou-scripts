...
function()
    local function rotate(trinkets, slotId)
        ...
        -- Feral Trinkets
        effectiveWindow[41589] = 167 -- Battlemaster's Determination
    ...
    local function rocketboots()
        if IsEquippedItem(23824) then
            ...
            local cooldown = startTime + duration - GetTime()
            if cooldown > 40 then
                local foo = {34999 ,35135 ,35001 ,0 ,35002 ,35152 ,34188 ,35137 ,35167 ,34998 ,35131 ,33496 ,0 ,0 ,41592 ,34198 ,0 ,29390}
                for i=1, 18 do
    ...
    C_Timer.After(0.2, function()
        ...
        if wa_global.spec5 == 'feral' then
            ...
            local feral_defensive = {
                ...
                41589, -- Battlemaster's Determination
