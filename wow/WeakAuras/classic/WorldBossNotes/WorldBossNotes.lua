function(e, text, _, _, _, _, _, _, _, _, _, _, guid, ...)
  if guid == UnitGUID('player') then
    ...
    guide['K'] = {
      '卡扎克 注意事项:',
      '1. 场地附近的小怪非常厉害, 引到无拾取不分金',
      '2. 任何减员会导致Boss回血70k+',
      '   a. 倒T所有治疗无拾取不分金',
      '   b. 其他职业没有规避可规避伤害或害死人无拾取不分金',
      '3. Boss正面有顺劈斩',
      '   a. 死于顺劈无拾取不分金',
      '4. Boss随机释放诅咒周期掉血掉蓝, 如果目标空蓝则会爆炸产生6k范围伤害',
      '   a.所有FS/德鲁伊驱散诅咒第一优先级, 诅咒三秒未驱散驱散量后半半份工资',
      '   b.所有有蓝职业保证自己蓝量40%以上, 如果引发爆炸无拾取不分金',
      '5. 吸血魔法, Boss每次攻击有吸血魔法的目标恢复25k生命值',
      '   a.牧师负责秒驱, 魔法三秒未驱散驱散量后半半份工资',
      '5. 近战范围雷霆, 群体暗影箭',
      '   a.所有治疗在保证自己蓝量健康, 坦克血量健康前提下缓慢抬团血'
    }
