...
print("")
print("Flins (息灾) ATK Hig:")
print(coeff(1612216, max(1623215, 1625209), 1590319))
print("Flins (息灾) ATK Low:")
print(coeff(1477079, max(1492099, 1492905), 1458919))
print("Flins (决斗) ATK Hig:")
print(coeff(1737448, max(1757832, 1747388), 1717322))
print("Flins (决斗) ATK Low:")
print(coeff(1616282, max(1634402, 1632564), 1599327))

print("")
print("Flins (R1) ATK Hig:")
print(coeff(1783283, max(1796343, 1788975), 1757619))
print("Flins (R1) ATK Low:")
print(coeff(1690101, max(1702596, 1704019), 1668557))
print("Flins (R1) EM Hig:")
print(coeff(1770343, max(1796343, 1788975), 1757619))
print("Flins (R1) EM Low:")
print(coeff(1574796, max(1597604, 1598633), 1565365))

print("")
print("Neuvillette (C2, HP/Hydro/HP) HP Hig:")
print(coeff(1819886, max(1819483, 1820774), 1788565))
print("Neuvillette (C2, HP/Hydro/HP) HP Low:")
print(coeff(1761147, max(1762652, 1772185), 1734901))

print("")
print("Noelle DEF Hig:")
print(coeff(389304, max(390005, 389725), 381373))
print("Noelle DEF Low:")
print(coeff(376077, max(378159, 369613), 369613))
print("Noelle ATK Hig:")
print(coeff(385121, max(390005, 389725), 381373))
print("Noelle ATK Low:")
print(coeff(341413, max(346181, 346191), 338358))
